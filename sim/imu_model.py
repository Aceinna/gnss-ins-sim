...
# low accuracy
gyro_low_accuracy = {'b': np.array([0.0*D2R, 0.0*D2R, 0.0*D2R]),
...
# mid accuracy
gyro_mid_accuracy = {'b': np.array([0.0*D2R, 0.0*D2R, 0.0*D2R]),
                     'b_drift': np.array([10.0*D2R, 10.0*D2R, 10.0*D2R])/3600.0,
                     'b_corr':np.array([float("inf"), float("inf"), float("inf")]),
                     'arw': np.array([0.75*D2R/60, 0.75*D2R/60, 0.75*D2R/60])}
...
mag_mid_accuracy = {'si': np.eye(3) + np.random.randn(3, 3)*0.0,
                    ...
                    'std': np.array([0.5, 0.5, 0.5])}
# high accuracy
gyro_high_accuracy = {'b': np.array([0.0*D2R, 0.0*D2R, 0.0*D2R]),
                      'b_drift': np.array([10.0*D2R, 10.0*D2R, 10.0*D2R])/3600.0,
                      'b_corr':np.array([float("inf"), float("inf"), float("inf")]),
                      'arw': np.array([0.75*D2R/60, 0.75*D2R/60, 0.75*D2R/60])}
    ...
    def __init__(self, accuracy='low-accuracy', axis=6, gps=True, gps_opt=None):
        ...
        if isinstance(accuracy, str):
            if accuracy == 'low-accuracy':                  # 'low-accuracy'
                ...
                self.gps_err = gyro_high_accuracy
