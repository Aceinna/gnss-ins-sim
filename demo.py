...
def test_sim():
    ...
    ini_pos_vel_att = np.genfromtxt(data_path+"//motion_def-static.csv",\
    ...
    #### start simulation
    sim = imu_sim.Sim([fs, fs_gps, fs_mag], imu, data_path+"//motion_def-static.csv",
                      ref_frame=1,
    ...
    # plot data
    # sim.plot(['att_euler', 'ref_att_euler'], opt={'pos': '3d'})
    print('test sim OK.')
